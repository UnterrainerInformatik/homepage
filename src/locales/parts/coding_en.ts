export default {
  ...
  gitListTitle: 'GIT Basic Steps &amp; Commands',
  gitListDescription: 'Here are the most commonly used GIT-commands, some information about our repositories and a description of the basic workflows using GIT',
  gitList: [
    {
      title: 'GIT Commands',
    ...
    },
    {
      ...
      value: `${''}<ol><li>If you have any uncommitted changes you want to revert (without losing any commits), type <pre>git reset --hard<br/>git pull</pre></li><li>If you want to revert these commits as well, type <pre>git reset --hard origin/&lt;branch&gt;<br/>git pull</pre></li></ol>`
    },
    {
