export default {
  ...
  string: '<table class=\'headerTable\'>',
  tabHome: 'HOME',
  throbaxVideoTeaser: '<iframe allowfullscreen=\'\' frameborder=\'0\' height=\'240\' src=\'https://www.youtube.com/embed/d1Lrtfo5MCM\' width=\'400\'></iframe>',
  throbaxSteamStorePage: 'https://store.steampowered.com/app/341570',
  throbaxSteamStoreImage: '<img src=\'https://files.unterrainer.info/logos/SteamLogo.png\' class=\'borderLess\' alt=\'STEAM Store Page\' width=\'270px\'>',
  throbaxFeedbackMailTo: 'mailto:feedback@unterrainer.info?subject=[feedback]%20On%20Trobax%20TD',
  adrStash: 'https://git.unterrainer.info',
  adrGithub: 'https://github.com/UnterrainerInformatik',
  adrMavenSearch: 'https://search.maven.org/#search%7Cga%7C1%7Cinfo.unterrainer',
  adrNugetSearch: 'https://www.nuget.org/packages?q=unterrainer'
}
